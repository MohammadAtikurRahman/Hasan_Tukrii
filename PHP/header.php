	...
	echo'<div class="big container flex-space">
            ...
            <nav class="flex-space">
                ...
                <ul class="nav-list nav-list-secondary flex-space">
                    '.((isset($_SESSION["loggedin"]) && $_SESSION["loggedin"]==true)?'<li class="nav-item"><a href="./AccountInfo.php" class="nav-link-button account">MY ACCOUNT</a></li>':'<li class="nav-item"><a href="./login.php" class="nav-link-button">Sign Up</a></li>').'
