...
<body>
          ...
          <div class="container border rounded p-3 mt-lg-5  " style="width: 600px">
        ...
        <form>
              ...
              <label class="form-label" for="customFile">Product Images</label>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="name">Product Catagory</label>
                <input type="name" class="form-control" id="name" aria-describedby="nameHelp">
              </div>
        ...
        <!-- <button href="registration.html" type="button"
         class="btn btn-outline-success"
          onclick=" redirectSign()">Sign In</button> -->
        </form>
